...
class RestrictBoxGroup {
    ...
    public:
        ...
        */
        RestrictBoxGroup(int x, int y, int xl, int yl, vector<RestrictBox*> boxes = {}) {
            this->x = x;
            this->y = y;
            xLen = xl;
            yLen = yl;
        ...
        */
        ...
        RestrictBox* clickedScan(sf::Vector2i mousePos) {
