// Run using 
// g++ -I src/include -L src/lib -o main test_SDL2.cpp -lmingw32 -lSDL2main -lSDL2 -lSDL2_image
// g++ -I src/include -L src/lib -o main test_SDL2.cpp -lmingw32 -lSDL2main -lSDL2 
#include <iostream>
#include <SDL2/SDL.h>
